...
// TODO: Buttons: instead of bool, use an enum with "click" types: click, doubleClick, longClick
...
pub async fn button1_job(pin: Peri<'static, PIN_12>) {
    let gpio = Input::new(pin, Pull::Up);
    let mut btn = Debouncer::new(gpio, Duration::from_millis(DEBOUNCE_MS));
    ...
    loop {
        ...
        crate::gui::button(current_state, (5, 120)).await;
...
pub async fn button2_job(pin: Peri<'static, PIN_13>) {
    ...
    loop {
        ...
        crate::gui::button(current_state, (50, 120)).await;
